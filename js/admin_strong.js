$(document).ready(function(){
    ...
    $("#13").click(function(){
        ...
        $.ajax({
            type: 'POST',
            url: address+'teacher/select_teacher',
            data: {},
            xhrFields: {
        ...
        $.ajax({
            type: 'GET',
            url: address+'model/select_model',
            data: {},
            xhrFields: {
                withCredentials: true
            },
    ...
    $("#NEW13").click(function(){
        ...
        $.ajax({
            ...
            url: address+'modelsubject/select_model_subject',
	...
	//数据集介绍
	$("#traffic-signs-2").click(function(){
    ...
    $("#search_btn").click(function(){
        ...
        $.ajax({
            ...
            url: address+'student/select_student',
    ...
    $("#btn_add_student").click(function(){
        ...
        $.ajax({
            ...
            url: address+'student/insert_student_eclass',
    ...
    $("#search_teacher_btn").click(function(){
        ...
        $.ajax({
            ...
            url: address+'teacher/like_select_teacher',
    ...
    $("#btn_add_teacher").click(function(){
        ...
        $.ajax({
            ...
            url: address+'teacher/insert_teacher',
    ...
    $("#save_update_student").click(function(){
        ...
        $.ajax({
            type: 'POST',
            url: address+'student/update_student',
    ...
    $("#save_update_teacher").click(function(){
        ...
        $.ajax({
            ...
            url: address+'teacher/update_teacher',
    ...
    $("#polity_search_btn").click(function(){
        ...
        $.ajax({
            ...
            url: address+'score/eclass_score',
    ...
    $("#teachclass_search_btn").click(function(){
        ...
        $.ajax({
            ...
            url: address+'score/tclass_score',
    ...
    $("#teacher_class_search_btn").click(function(){
        ...
        $.ajax({
            ...
            url: address+'teachclass/select_tclass',
    ...
    $("#btn_add_tclass_student").click(function (){
        ...
        $.ajax({
            ...
            url: address+'student/insert_student_tclass',
    ...
    $("#save_add_tclass").click(function (){
        ...
        $.ajax({
            ...
            url: address+'teachclass/insert_tclass',
    ...
    $("#save_add_tclass_update").click(function (){
        ...
        $.ajax({
            ...
            url: address+'teachclass/update_tclass_teacher',
    ...
    $("#search_ModelClass").click(function(){
        ...
        $.ajax({
            ...
            url: address+'model/select_one_model_subject',
    ...
    $("#add_NewModelClass_BTN").click(function(){
        ...
        $.ajax({
            ...
            url: address+'model/insert_model',
    ...
    $("#update_NewModelClass_BTN").click(function(){
        ...
        $.ajax({
            ...
            url: address+'model/update_model',
    ...
    $("#add_NewExamSubject_BTN").click(function(){
        ...
        $.ajax({
            ...
            url: address+'model/set_model_subject',
    ...
    $("#btn_add_NewExamSubject").click(function(){
        ...
        $.ajax({
            ...
            url: address+'modelsubject/insert_model_subject',
    ...
    $("#btn_update_NewExamSubject").click(function(){
        ...
        $.ajax({
            ...
            url: address+'modelsubject/update_model_subject',
    ...
    function show_Standard() {
        ...
        $.ajax({
            ...
            url: address+'modelstandard/select_model_standard',
    ...
    $("#btn_add_NewStandard").click(function(){
        ...
        $.ajax({
            ...
            url: address+'modelstandard/insert_model_standard',
    ...
    $("#btn_Standard_NewExamSubject").click(function(){
        ...
        $.ajax({
            ...
            url: address+'modelstandard/update_model_standard',
    ...
    function show_SCORE_IN() {
        ...
        $.ajax({
            ...
            url: address+'scorerange/select_model_range',
    ...
    $("#btn_add_NewScore").click(function (){
        ...
        $.ajax({
            ...
            url: address+'scorerange/insert_model_range',
    ...
    $("#btn_update_SetScore").click(function (){
        ...
        $.ajax({
            ...
            url: address+'scorerange/update_model_range',
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    url: address+'student/delete_student',
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    url: address+'teacher/delete_teacher',
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    url: address+'student/delete_student_tclass',
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    url: address+'modelsubject/delete_model_subject',
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    url: address+'modelstandard/delete_model_standard',
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    url: address+'scorerange/delete_model_range',
        ...
        function(isConfirm){
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    url: address+'model/del_model_subject',
